...
<div id="wrapper">
    ...
    <%
        ...
        try {
                ...
                pro = prm.getProductByIdAmin(productId);
            } catch (Exception e) {
                e.printStackTrace();
            }
    %>
                                ...
                                <div class="col-lg-6">
                                    <form action="UpdateProduct" method="post" enctype="multipart/form-data">
                                          <div class="form-group">
                                              <label>Mã Sản phẩm</label> <input  readonly="" class="form-control" name="productId" value="<%=pro.getProductId()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Tên sản phẩm</label> <input value="<%=pro.getProductName()%>" class="form-control" name="nameProduct"/>
                                        </div>
                                         <div class="form-group">
                                             <label>Giá sản phẩm</label> <input value="<%=pro.getPrice()%>" class="form-control"  name="price"/>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="descriptions"  value="<%=pro.getDescriptions()%>"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Số lượng</label> <input type="text" class="form-control" placeholder="Số lượng" name="quantity" value="<%=pro.getQuantity()%>">
                                        </div>
                                        <div class="form-group">
                                            <label>Active</label>
                                            <div class="radio">
                                                <label> 
                                                    <input type="radio" name="proStatus"  value="true" />Hiển thị
                                                </label>
                                            </div>
                                            <div class="radio">
                                                <label> 
